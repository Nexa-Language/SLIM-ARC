...
`Qwen3-Next-80B-A3B-Instruct-Q4_K_M.gguf` model under a 2 GiB cgroup-v2 memory
limit, 4 CPUs, no swap, CPU-only mmap loading, `pp64/tg16`, and one repetition.
...
At a 2 GiB physical-memory cap, the active layer/expert `WILLNEED` streams
