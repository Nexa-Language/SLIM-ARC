...
void llama_model_loader::init_mappings(bool prefetch, llama_mlocks * mlock_mmaps) {
        ...
        for (const auto & file : files) {
            ...
            // SLIM_ARC_NO_MADV_RANDOM=1 to disable.
            {
                ...
                if (!slim_arc_disabled && !no_madv && msz > (6ULL << 30) &&
                    ...
                    // Register mmap region for dynamic MADV switching in graph_compute
                    // (prefill → WILLNEED, decode → MADV_RANDOM)
    ...
    // SLIM-ARC: initialize prefetch scheduler and unified I/O scheduler.
