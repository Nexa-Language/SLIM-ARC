...
def _success_metrics(directory: Path, wrapper: Mapping[str, object], variant: str) -> tuple[float, int, int, float, float]:
    ...
    if metrics:
        ...
        if set(metric) != {"schema", *COUNTERS} or metric.get("schema") != 1:
