...
|------|---------|---------|------|
| pp32 (prefill) | 1.04 | **1.26** | +21% |
| **tg8 (decode)** | **0.18** | **0.90** | **+400% (5×)** |

### 32GB 无限制（热缓存，8 threads）

| 指标 | SLIM-ARC | 说明 |
|------|---------|------|
| pp32 | **1.90 t/s** | prefill 快速 |
| **tg8** | **1.24 t/s** | **接近流畅运行（0.8s/token）** |

**结论**: 80B 在 16GB cgroup 下 SLIM-ARC decode 5 倍提升；32GB 热缓存下达到 1.24 t/s 接近流畅。
