...
\newcommand{\reporttitle}{SLIM-ARC: Synergistic LLM Integration with Memory-Aware Runtime Co-Optimization for On-Device Agents}
...
\begin{titlepage}
    ...
    \begin{center}
    {\large
    \makebox[6em][s]{队\quad名}:\underline{\makebox[16em][c]{\kaishu \teamname}}\\[0.8em]
    \makebox[6em][s]{组\quad员}:\underline{\makebox[16em][c]{\kaishu \members}}\\[0.8em]
    \makebox[6em][s]{指导教师}:\underline{\makebox[16em][c]{\kaishu \advisers}}\\[0.8em]
    \makebox[6em][s]{学\quad校}:\underline{\makebox[16em][c]{\kaishu \schoolname}}\\[0.8em]
    \makebox[6em][s]{赛\quad道}:\underline{\makebox[16em][c]{\kaishu \trackname}}\\[0.8em]
    \makebox[6em][s]{选\quad题}:\underline{\makebox[16em][c]{\kaishu \projnum}}\\[0.8em]
    \makebox[6em][s]{日\quad期}:\underline{\makebox[16em][c]{\kaishu \labdate}}
    }
    \end{center}
