...
% Figure: 优化效果总览雷达图
% 需要生成的 matplotlib 图表: radar chart showing 5 dimensions (memory efficiency, decode speed, prefill speed, reproducibility, integration depth)
%   for 4 configs: baseline, +MADV, +MADV+KVq4, +MADV+KVq4+IQ4XS
