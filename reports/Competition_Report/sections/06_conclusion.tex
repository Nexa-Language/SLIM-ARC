...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{figures/fig_volatility_radar.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/fig_optimization_dumbbell.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/fig_small_models.png}
