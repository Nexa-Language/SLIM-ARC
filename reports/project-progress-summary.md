...
### 核心成果：80B 在 8GB 最受限环境 decode 提升 343%

| 模型 | 环境 | Baseline pp4 | SLIM-ARC pp4 | 提升 |
|------|------|-------------|-------------|------|
| Qwen3-Next-80B | 8GB | 0.17 | **0.20** | +17.6% |
| Qwen3-Next-80B | 8GB tg1 | 0.07 | **0.31** | **+343%（4.4倍）** |
| Qwen3-Next-80B | 16GB | 0.17 | 0.17 | 持平 |
| Qwen3-Next-80B | 16GB tg1 | 0.31 | 0.38 | +22.6% |

**80B 在 8GB 环境下 SLIM-ARC 的 decode 速度是 baseline 的 4.4 倍**。这是最核心的对比数据，证明了 mmap + MADV_RANDOM + prefetch_scheduler 在最受限环境下的巨大优势。
