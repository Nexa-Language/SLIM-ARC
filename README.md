...
[![Website](https://img.shields.io/badge/website-slim.nexa--lang.com-orange.svg)](https://slim.nexa-lang.com)
...
| **量化优化层** | 算法侧优化 | IQ4_XS 权重 + KV q4_0 + FlashAttention + StreamingLLM eviction |
...
- [FlexInfer (EuroMLSys'25)](docs/papers/FlexInfer%20Breaking%20Memory%20Constraint...pdf) — 端侧 LLM 权重卸载（参考）
